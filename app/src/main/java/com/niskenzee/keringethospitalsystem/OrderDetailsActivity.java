...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEmail = findViewById(R.id.butonBMDAddToCart2);
        btnMpesa = findViewById(R.id.butonBMDAddToCart3);
        ...
        btnEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String mailto = "mailto:dennruttoh@gmail.com" +
                        "?cc=" +
                        "&subject=" + Uri.encode("My Medical Order") +
                        "&body=" + Uri.encode("Hi\n"+"Hello please find my order in the screenshot attached below.");
        ...
        for (int i = 0; i <order_details.length; i++){
            ...
            order_details[i][2] = "Ksh."+strData[6];
